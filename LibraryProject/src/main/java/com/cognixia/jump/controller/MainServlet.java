...
public class MainServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) 
		...
		case "/book-list":
			...
			break;
		case "/add-book":
			goToAddUpdateBook(request, response);
			break;
		case "/add":
	...
	private void goToAddUpdateBook(HttpServletRequest request, HttpServletResponse response) 
			throws ServletException, IOException {
...
//		request.setAttribute("allBook", allBooks);
	...
	private void addNewBook(HttpServletRequest request, HttpServletResponse response) 
		...
		//Create object for our product - we need to add the addedDate
	...
	private void updateBook(HttpServletRequest request, HttpServletResponse response)
		...
		String addedDate = request.getParameter("added_to_library");
		
		// we need to get the addedDate
		Book book = new Book(isbn, title, description, rented, Date.valueOf(addedDate)); 
